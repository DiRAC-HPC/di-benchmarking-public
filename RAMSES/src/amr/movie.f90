...
subroutine output_frame()
  ...
  character(LEN=80)::moviedir,moviecmd,infofile,sinkfile
#ifdef SOLVERmhd
  character(LEN=80),dimension(0:NVAR+7) :: moviefiles
#else
  character(LEN=80),dimension(0:NVAR+3) :: moviefiles
#endif
#if NENER>0
  integer::irad
#endif
#ifdef RT
  character(LEN=80)::rt_infofile
#endif
...
#endif
#ifdef RT
  character(LEN=80),dimension(1:NGROUPS) :: rt_moviefiles
