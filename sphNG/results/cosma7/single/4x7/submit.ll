...
export SPH_HOME=$SPH_ROOT/runs/single/${mpicnt}x${threadspermpi}
cd $SPH_HOME


mpirun -n $SLURM_NTASKS -ppn $SLURM_NTASKS_PER_NODE $SPH_EXE_DIR/sph_tree_rk_gradh initial ifile < $SPH_HOME/setup.txt &> sphng_setup.o$SBATCH_JOBID
